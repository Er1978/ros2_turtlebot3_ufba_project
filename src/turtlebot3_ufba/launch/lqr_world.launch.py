# /home/turtlebot3_ws/src/turtlebot3_ufba/launch/lqr_world.launch.py
import os
...
def generate_launch_description():
    ...
    declare_control_arg = DeclareLaunchArgument(
        'control',
        default_value='L',
        description='Especifica qual controle será usado (L-LQR (default) ou N-Normal)'
    )
    ...
    control_node = Node(
        package=pkg_name,
        executable='turtle_lqr_controller',
        name='turtle_lqr_controller_node',
        output='screen',
